...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { Cid: @seller.Cid, DoB: @seller.DoB, address: @seller.address, contact_no: @seller.contact_no, email: @seller.email, fullname: @seller.fullname, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { Cid: @seller.Cid, DoB: @seller.DoB, address: @seller.address, contact_no: @seller.contact_no, email: @seller.email, fullname: @seller.fullname, user_id: @seller.user_id } }
